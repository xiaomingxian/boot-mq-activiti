...
@ToString
@Configuration
@ConfigurationProperties(prefix = "nomal.rocketmq.consumer")
public class MQConsumerConfigure {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "nomal.rocketmq.consumer", value = "isOnOff", havingValue = "on")
    public DefaultMQPushConsumer defaultConsumer() throws MQClientException {
        LOGGER.info("defaultConsumer 正在创建消费者---------------------------------------");
...
//        consumer.setMessageModel(MessageModel.CLUSTERING);
        ...
        try {
            ...
            consumer.start();
            LOGGER.info("consumer 创建成功消费者 groupName={}, topics={}, namesrvAddr={}",groupName,topics,namesrvAddr);
        } catch (MQClientException e) {
            LOGGER.error("consumer 创建失败消费者!");
        }
        return consumer;
    }
}